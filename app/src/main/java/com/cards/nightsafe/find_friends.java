...
public class find_friends extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("GoogleKeyTest", "" + R.string.google_maps_key);
   ...
   /*@Override
    ...
    private double getMarkerLat() {
        return 0.07;
    }

    private double getMarkerLon() {
        return 0.07;
    }
    ...
    public void onMapReady(GoogleMap map) {
        ...
        LatLng sydney = new LatLng(getMarkerLat(), getMarkerLon());
        map.addMarker(new MarkerOptions().position(sydney)
                .title("Marker in Where You Want"));
            ...
            placeResult.addOnCompleteListener(new OnCompleteListener<FindCurrentPlaceResponse>() {
                ...
                public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        find_friends.this.openPlacesDialog();
                    } else {
                        Log.e(TAG, "Exception: %s", task.getException());
                    }
                }
    ...
    private class Download extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result.equals("Complete")) {
                ...
                adapter = new findAdaptor(groupList);
